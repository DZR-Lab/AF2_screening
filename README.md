...
9. If jobs run out of time or memory, create input files to restart analysis where it left off.
```bash
...
Note: This script can be run while your folds are ongoing. It will analyze any completed folds found in your `output/` directory.
